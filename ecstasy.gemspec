...
Gem::Specification.new do |gem|
  ...
  gem.description   = %q{After crack, cocaine, cannabis, speed, the ecstasy gems sole purpose is keeping the Ruby community from releasing more drug-related gems.}
